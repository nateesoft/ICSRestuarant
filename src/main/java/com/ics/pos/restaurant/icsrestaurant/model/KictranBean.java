...
public class KictranBean {
    ...
    private String rFoodurgent;
    private String rAlertkitchen;
    private String rShowdisplayalert;
    private String rPrintcheckout;
    private String rUrgentfooditemname;
}
